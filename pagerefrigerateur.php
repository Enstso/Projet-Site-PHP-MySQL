...
<body>
  ...
  <!-- Header -->
   <header>
     <!-- Section principale -->
    <h1 class="Titre-main">Réfrigérateur</h1>
    <?php 
include "pdo.php";

$req="SELECT * FROM Produit where num_catalog = 2";	//On crée une variable $requete (le nom importe peu) contenant une requête sql
